...
@Component({
  selector: 'app-users-registration-details',
  standalone: true,
  imports: [],
  templateUrl: './users-registration-details.component.html',
  styleUrl: './users-registration-details.component.scss'
})
export class UsersRegistrationDetailsComponent {
  ...
  submit() {
    this.userRegistrationQueueService.Delete(this.userRegistrationQueue.id).subscribe({
      next: (response) => {
